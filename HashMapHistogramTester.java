...
public class HashMapHistogramTester {
	public static void main(String[] args) {
		...
		HashMapHistogram<Integer> hmh = new HashMapHistogram<>();
		hmh.addItem(1);
		hmh.addItem(2);
		hmh.addItem(2);hmh.addItem(2);	hmh.addItem(3);hmh.addItem(3);hmh.addItem(3);hmh.addItem(4);
		Iterator<Integer> it1 =hmh.iterator();
